...
def main():
	...
	LOGPATH_pref = "//home//pokerbot//pokerbot2015//logs//Day_5//Casino_Day-5_Nuts_p"
	OUT_FILENAME = LOGPATH_pref + '_new_2.csv'
	OUT_FILE_TEAMS = LOGPATH_pref + '_teams_new_2.csv'
	resultmat = []
	teamsmat = []
