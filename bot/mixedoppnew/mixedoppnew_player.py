...
class MixedoppnewPlayer(base_player.BasePlayer):
  def __init__(self):
    super(MixedoppnewPlayer, self).__init__()
    self.current_bot = mixedoppnew_bot.MixedoppnewBot(self)
  
  def new_game(self, parts):
    super(MixedoppnewPlayer, self).new_game(parts)
    
  def new_hand(self, parts):
    super(MixedoppnewPlayer, self).new_hand(parts)
    
  def handover(self, parts):
    super(MixedoppnewPlayer, self).handover(parts)
