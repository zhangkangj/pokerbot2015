...
class MixedstrongerBot(base_bot.BaseBot):
  ...
  def action(self):
    ...
    return super(MixedstrongerBot, self).action(equity*0.8, can_raise, can_bet, can_call)
  ...
  def mid_card(self, equity, can_raise, can_bet, can_call):
    result = self.action_equity(equity, can_raise, can_bet, can_call, 0.625);
    return result
