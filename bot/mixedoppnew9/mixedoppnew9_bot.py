...
import mixedoppnew9_param
import bot_action_lib
import top_play_lib

class Mixedoppnew9Bot(base_bot.BaseBot):

  def __init__(self, player):
    super(Mixedoppnew9Bot, self).__init__(player)
    self.param = mixedoppnew9_param.Mixedoppnew9Param()
  ...
  def action(self):
    ...
    return super(Mixedoppnew9Bot, self).action(equity, can_raise, can_bet, can_call)
