...
for i in range(100000):
  ...
  for sb, bb, _ in itertools.permutations([0,1,2]):
   ...
   util_bb += util_bb_
  if i%1000 == 0:
    print 'sb: root              ', normalize(root.child_nodes[0].regret[0:6])
    print 'bb: sb check          ', normalize(root.child_nodes[0].child_nodes[0].regret[0:6])
    print 'bb: sb raise          ', normalize(root.child_nodes[0].child_nodes[1].regret[0:6])
    print 'sb: sb check, bb raise', normalize(root.child_nodes[0].child_nodes[0].regret[0:6])
