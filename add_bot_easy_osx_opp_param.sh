...
NAIVE_OPPONENT_PY_PATH="./bot/$NAIVE_BOT_NAME_PREFIX/"$NAIVE_BOT_NAME_PREFIX"_opponent.py"
echo "NAIVE_OPPONENT_PY_PATH=$NAIVE_OPPONENT_PY_PATH"

NAIVE_PARAM_PY_PATH="./bot/$NAIVE_BOT_NAME_PREFIX/"$NAIVE_BOT_NAME_PREFIX"_param.py"
echo "NAIVE_PARAM_PY_PATH=$NAIVE_PARAM_PY_PATH"
...
OPPONENT_PY_PATH="$BOT_PLAYER_DIR_PATH/$BOT_NAME_PREFIX"_opponent.py
PARAM_PY_PATH="$BOT_PLAYER_DIR_PATH/$BOT_NAME_PREFIX"_param.py
cp $NAIVE_BOT_PY_PATH $BOT_PY_PATH
cp $NAIVE_PLAYER_PY_PATH $PLAYER_PY_PATH
cp $NAIVE_OPPONENT_PY_PATH $OPPONENT_PY_PATH
cp $NAIVE_PARAM_PY_PATH $PARAM_PY_PATH
...
sed -i"$OSX_SED_EXTRA" "s/$NAIVE_BOT_NAME_PREFIX/$BOT_NAME_PREFIX/g" "$OPPONENT_PY_PATH"
sed -i"$OSX_SED_EXTRA" "s/$NAIVE_BOT_NAME_PREFIX_UPPER/$BOT_NAME_PREFIX_UPPER/g" "$OPPONENT_PY_PATH"
sed -i"$OSX_SED_EXTRA" "s/$NAIVE_BOT_NAME_PREFIX/$BOT_NAME_PREFIX/g" "$PARAM_PY_PATH"
sed -i"$OSX_SED_EXTRA" "s/$NAIVE_BOT_NAME_PREFIX_UPPER/$BOT_NAME_PREFIX_UPPER/g" "$PARAM_PY_PATH"

# copy over files that needs no replacement
cp "$NAIVE_BOT_PLAYER_DIR_PATH"/__init__.py "$BOT_PLAYER_DIR_PATH"/
cp "$NAIVE_BOT_PLAYER_DIR_PATH"/*lib.py "$BOT_PLAYER_DIR_PATH"/
